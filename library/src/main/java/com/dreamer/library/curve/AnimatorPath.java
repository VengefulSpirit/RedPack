...
public class AnimatorPath {
    ...
    public void moveTo(PointF pointF) {
        mPoints.add(PathPoint.moveTo(pointF));
    }
    ...
    public void lineTo(PointF pointF) {
        mPoints.add(PathPoint.lineTo(pointF));
    }
     ...
     */
    public void curveTo(PointF controlOne, PointF controlTwo, PointF current) {
        mPoints.add(PathPoint.curveTo(controlOne, controlTwo, current));
    }
